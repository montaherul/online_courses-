...
<div class="add-course-container">
    ...
    <form action="add-course" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="coursePrice" name="price" step="0.01" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" id="instructorImage" name="instructor image" required>
        </div>

        <button type="submit" class="btn btn-primary">Add Course</button>
        <a href="${pageContext.request.contextPath}/courses?action=list" class="btn btn-secondary">Cancel</a>
    </form>
</div>
