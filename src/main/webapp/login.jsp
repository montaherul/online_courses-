    ...
    <div class="login-card">
        ...
        <form action="loginUser" method="post" class="login-form">
            ...
            <div class="form-options">
                ...
                <a href="${pageContext.request.contextPath}/forgotPassword.jsp" class="forgot-password">Forgot Password?</a>
            </div>
            <button type="submit" class="btn btn-primary btn-submit">Login</button>
        </form>

        <div class="register-link">
            <span>Don't have an account? </span><a href="${pageContext.request.contextPath}/register.jsp"
