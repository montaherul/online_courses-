...
<head>
    ...
    <title>Error | Course Enrollment System</title>
    <!-- Bootstrap CSS -->
...
<div class="container error-container">
    <header class="text-center">
        <h1 class="display-6 text-uppercase">Error Occurred</h1>
    </header>
    <main class="text-center">
        <p class="lead">We're sorry, but something went wrong on our end.</p>
        <p>Please try again later or contact support if the issue persists.</p>
        <a href="${pageContext.request.contextPath}/home.jsp" class="btn btn-primary">Return to Home</a>
    </main>
</div>
