...
<form action="${pageContext.request.contextPath}/register-user" method="post" enctype="multipart/form-data">
    <div class="registration-container">
        <div class="register-card">
            ...
            <!-- HSC -->
            <div class="mb-3">
                <label for="hsc" class="form-label">SSC GPA</label>
                <input type="text" class="form-control" id="hsc" name="hsc" placeholder="Enter your SSC GPA">
            </div>
            ...
            <!-- Parent Mobile -->
            <div class="mb-3">
                <label for="parentMobile" class="form-label">Parent's Mobile</label>
                <input type="text" class="form-control" id="parentMobile" name="parentMobile" placeholder="Enter your parent's mobile number">
            </div>

            <!-- Institution -->
            <div class="mb-3">
                <label for="institution" class="form-label">Institution</label>
                <input type="text" class="form-control" id="institution" name="institution" placeholder="Enter your institution name">
            </div>

            <!-- Facebook -->
            <div class="mb-3">
                <label for="facebook" class="form-label">Facebook</label>
                <input type="text" class="form-control" id="facebook" name="facebook" placeholder="Enter your Facebook profile link">
            </div>
